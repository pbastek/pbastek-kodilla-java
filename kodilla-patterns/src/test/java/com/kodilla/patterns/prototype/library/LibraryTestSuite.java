...
public class LibraryTestSuite {
    ...
    @Test
    public void should_returnBooks() {
        //Given
        ...
        try {
            ...
            shallowCopy.setName("Public library shallow copy");
        } catch (CloneNotSupportedException e) {
            System.out.println("Can not clone Public library: shallow copy");
        }

        Library deepCopy = null;
        try {
            deepCopy = library.deepCopy();
            deepCopy.setName("Public library deep copy");
        } catch (CloneNotSupportedException e) {
            System.out.println("Can not clone Public library: deep copy");
        }
